...
var saveList = function() {
	...
	new Ajax('../wp-content/plugins/mindvalley-pagemash/savelist.php', {
		method: 'post',
...
window.addEvent('domready', function(){ 
	...
	$('toggle_display').addEvent('click', function(e){ e = new Event(e);
		$$('span.pageMash_box').toggleClass('showAll');
	e.stop(); });
